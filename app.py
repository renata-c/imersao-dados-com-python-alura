...
# Para rodar esse dashboard no navegador (local URL), é só abrir um novo terminal e digitar > streamlit run app.py
...
#residencias_selecionadas = st.sidebar.multiselect(
#    "Residência", residencias_disponiveis, 
#    default=residencias_disponiveis)
